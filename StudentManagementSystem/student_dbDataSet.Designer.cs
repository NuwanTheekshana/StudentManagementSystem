...
namespace StudentManagementSystem {
    ...
    public partial class student_dbDataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsersRow AddUsersRow(string username, string password_hash, string role, string email, System.DateTime created_at) {
...
namespace StudentManagementSystem.student_dbDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Users] ([username], [password_hash], [role], [email], [created_at]) VALUES (@username, @password_hash, @role, @email, @created_at);
SELECT user_id, username, password_hash, role, email, created_at FROM Users WHERE (user_id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [username] = @username, [password_hash] = @password_hash, [role] = @role, [email] = @email, [created_at] = @created_at WHERE (([user_id] = @Original_user_id) AND ([username] = @Original_username) AND ([password_hash] = @Original_password_hash) AND ((@IsNull_role = 1 AND [role] IS NULL) OR ([role] = @Original_role)) AND ([email] = @Original_email) AND ((@IsNull_created_at = 1 AND [created_at] IS NULL) OR ([created_at] = @Original_created_at)));
SELECT user_id, username, password_hash, role, email, created_at FROM Users WHERE (user_id = @user_id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT user_id, username, password_hash, role, email, created_at FROM dbo.Users";
        ...
        public virtual int Fill(student_dbDataSet.UsersDataTable dataTable) {
        ...
        public virtual student_dbDataSet.UsersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            student_dbDataSet.UsersDataTable dataTable = new student_dbDataSet.UsersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(student_dbDataSet.UsersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_user_id, string Original_username, string Original_password_hash, string Original_role, string Original_email, global::System.Nullable<global::System.DateTime> Original_created_at) {
        ...
        public virtual int Insert(string username, string password_hash, string role, string email, global::System.Nullable<global::System.DateTime> created_at) {
            if ((username == null)) {
        ...
        public virtual int Update(string username, string password_hash, string role, string email, global::System.Nullable<global::System.DateTime> created_at, int Original_user_id, string Original_username, string Original_password_hash, string Original_role, string Original_email, global::System.Nullable<global::System.DateTime> Original_created_at, int user_id) {
            if ((username == null)) {
                throw new global::System.ArgumentNullException("username");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string username, string password_hash, string role, string email, global::System.Nullable<global::System.DateTime> created_at, int Original_user_id, string Original_username, string Original_password_hash, string Original_role, string Original_email, global::System.Nullable<global::System.DateTime> Original_created_at) {
            return this.Update(username, password_hash, role, email, created_at, Original_user_id, Original_username, Original_password_hash, Original_role, Original_email, Original_created_at, Original_user_id);
        }
    }
